            ...
            >
                ...
                <label>
                    ...
                    <input
                        ...
                        autoComplete='off'
                        onChange={(e) => {
                            setDeleteAfterExport(e.target.checked)
                        }}
                    />
                </label>
                ...
                <button
                    className='app'
                    disabled={exportResponse.isLoading || !agentID}
                    onClick={() => {
                        if (
                            deleteAfterExport &&
                            !confirm(
                                'Книги будут удалены из системы после экспорта, продолжить?'
                            )
                        ) {
                            return
                        }
                        ...
                        makeExport({
                            ...
                            }, // Принудительно срезаем параметры пагинации.
